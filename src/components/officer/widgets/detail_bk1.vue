            ...
            <div class="left-panel absolute left-0 top-0 bottom-0 w-48 bg-gray-100/80" >
              <n-scrollbar >
                <div class="officer-information-panel" >
                  <div v-if="$hasPermission('portal_staff_profile_information')" :class=" ( activeMenu == 'profile' ? 'officer-information-item-active bg-blue-500/80 duration-500  text-white' : 'officer-information-item hover:bg-blue-500/80 duration-500  hover:text-white' ) + ' w-full cursor-pointer ' " >
