    ...
    <div v-if="show" class="birth-information absolute left-0 right-0 bottom-0 top-0 bg-white" >
        <Transition name="slide-fade" >
            <div v-if="record != undefined && record != null " class="absolute left-0 right-0 bottom-0 top-0 p-8 mb-0" >
                <div class="font-moul border-b border-gray-200 w-full pb-2 mb-4 h-10 leading-6 relative" >ព័ត៌មានភាសាបរទេស
                ...
                <n-scrollbar >
                    <div class="body" >
                        ...
                        <div v-if="languages == undefined || languages == null || ( languages.length <= 0 )" class="text-center p-16" >
