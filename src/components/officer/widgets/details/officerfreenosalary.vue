    ...
    <div v-if="show" class="birth-information absolute left-0 right-0 bottom-0 top-0 bg-white" >
        <Transition name="slide-fade" >
            <div v-if="record != undefined && record != null " class="absolute left-0 right-0 bottom-0 top-0 p-8 mb-0" >
                <div class="font-moul border-b border-gray-200 w-full pb-2 mb-4 h-10 leading-6 relative" >ស្ថានភាពស្ថិតនៅក្នុងភាពទំនេរគ្មានបៀវត្ស
    ...
    export default {
        ...
        setup(props){
            ...
            function save(){
                ...
                if( !(parseInt( officernosalary.total_months ) > 0 ) ){
                    notify.warning({
                        title: 'បំពេញព័ត៌មាន' ,
                        content: 'សូមបំពេញចំនួនខែ' ,
                        duration: 2000
                    })
                    return false
                }
