  ...
  <div class="ocm-float-menu-bottom fixed top-0 left-0 right-0 p-0 h-12 flex bg-blue-700" >
    ...
    <div class="absolute right-0 h-12 p-2 w-12 sm:visible md:w-40 lg:w-40 xl:w-40 flex flex-row-reverse cursor-pointer" @click="$router.push('/profile')" >
      <div class="flex-none rounded-full overflow-hidden w-8 h-8 " >
        <div v-if="profilePicture!=null" class="rounded-full border-gray-200 w-8 h-8 flex-none mx-auto overflow-hidden bg-center bg-no-repeat bg-cover bg-white " :style=" 'background-size: 80%; background-image: url(' + profilePicture +');' " ></div>
    ...
    <div class="ocm-bottom-menu w-full flex flex-row-reverse items-center mr-12 " >
      ...
      <!-- <n-tooltip trigger="hover" >
        <template #trigger>
          <div 
            ...
            class="flex-none mx-2 h-8 w-8 p-1 text-white rounded-full cursor-pointer border border-gray-300 duration-300 transform-gpu hover:scale-125" >
      ...
      <n-tooltip trigger="hover" >
        <template #trigger>
          <div 
            @click="logout"
            class="flex-none mx-2 h-8 w-8 p-1 text-red-500 bg-white cursor-pointer border border-gray-300 duration-300 transform-gpu hover:scale-125" >
