        ...
        <n-card class="relative w-12/12 min-h-screen font-pvh text-xl p-0 " :bordered="false" size="small">
          <div class="absolute left-8 top-8 right-8 bottom-8 bg-white border border-gray-300 rounded p-8 -my-3 -mx-4">
            <div class="left-panel absolute left-0 top-0 bottom-0 w-48 bg-gray-100/80" >
              <n-scrollbar >
                <div class="officer-information-panel" >
                  ...
                  <div :class=" ( activeMenu == 'childCertificates' ? 'officer-information-item-active bg-blue-500/80 duration-500  text-white' : 'officer-information-item hover:bg-blue-500/80 duration-500  hover:text-white' ) + ' w-full cursor-pointer ' " >
                    <div class="officer-information-content border-b border-gray-200 py-2" @click="setActiveMenu('childCertificates')" >
                      <svg class="w-12 h-12 rounded-lg mx-auto " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><path d="M26 16h-8.532l-5-6H5a3.003 3.003 0 0 0-3 3v6a2.002 2.002 0 0 0 2 2v7a2.002 2.002 0 0 0 2 2h4a2.002 2.002 0 0 0 2-2v-7h-2v7H6v-9H4v-6a1 1 0 0 1 1-1h6.532l5 6H26a1 1 0 0 1 1 1v3h-2v6h-3v-6h-2v6a2.002 2.002 0 0 0 2 2h3a2.002 2.002 0 0 0 2-2v-4a2.002 2.002 0 0 0 2-2v-3a3.003 3.003 0 0 0-3-3z" fill="currentColor"></path><path d="M23.5 15a3.5 3.5 0 1 1 3.5-3.5a3.504 3.504 0 0 1-3.5 3.5zm0-5a1.5 1.5 0 1 0 1.5 1.5a1.502 1.502 0 0 0-1.5-1.5z" fill="currentColor"></path><path d="M8 9a4 4 0 1 1 4-4a4.004 4.004 0 0 1-4 4zm0-6a2 2 0 1 0 2 2a2.002 2.002 0 0 0-2-2z" fill="currentColor"></path></svg>
                  ...
                  <div :class=" ( activeMenu == 'salaryrange' ? 'officer-information-item-active bg-blue-500/80 duration-500  text-white' : 'officer-information-item hover:bg-blue-500/80 duration-500  hover:text-white' ) + ' w-full cursor-pointer ' " >
                  ...
                  <div :class=" ( activeMenu == 'org_pos' ? 'officer-information-item-active bg-blue-500/80 duration-500  text-white' : 'officer-information-item hover:bg-blue-500/80 duration-500  hover:text-white' ) + ' w-full cursor-pointer ' " >
                  ...
                  <div :class=" ( activeMenu == 'rewards' ? 'officer-information-item-active bg-blue-500/80 duration-500  text-white' : 'officer-information-item hover:bg-blue-500/80 duration-500  hover:text-white' ) + ' w-full cursor-pointer ' " >
            ...
            <div class="right-panel absolute left-48 top-0 bottom-0 right-0 bg-gray-100/50 border-l border-gray-300 p-8" >
              ...
              <!-- Educations -->
              <education-certificate v-bind:model="model" v-bind:record="record" v-bind:show="showEducationPanel" />
              <!-- Birth Certificates -->
...
export default {
  ...
  setup(props){
    ...
    function setActiveMenu( menu ){
      ...
      showBackgroundInformationPanel.value = 
      showRewardsPanel.value = 
      showOrgposPanel.value = 
      showSalaryRangePanel.value = 
      showProfilePanel.value = 
      showEducationPanel.value = 
      showBirthCertificatePanel.value = 
      showWeddingCertificatePanel.value = 
      showNicPanel.value = 
      showPassportPanel.value = 
      showChildCertificatePanel.value = false
    ...
    function getProvinces(){
      store.dispatch( 'province/list' ).then( res => {
        ...
        console.log( store.getters['province/records'] )
      }).catch( err => {
        console.log( err )
      })
    }
