    ...
    <div v-if="show" class="birth-information absolute left-0 right-0 bottom-0 top-0 bg-white" >
        <Transition name="slide-fade" >
            <div v-if="record != undefined && record != null " class="absolute left-0 right-0 bottom-0 top-0 p-8 mb-0" >
                <div class="font-moul border-b border-gray-200 w-full pb-2 mb-4 h-8 leading-6 relative" >ការដំឡើងឋានន្តរស័ក្កិ និងថ្នាក់តាមសញ្ញាបត្រ
                        ...
                        <table class="w-full" >
                            <thead>
                                <tr class="w-full " >
                                    ...
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >គ្រឹះស្ថានបណ្ដុះបណ្ដាល</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ទីកន្លែងសិក្សា</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >សញ្ញាបត្របានទទួល</th>
                            ...
                            <tbody>
                                <tr v-for="(officerRank , index) in officerRanks" :key="index" class="certificate relative w-full rounded-lg shadow bg-white mb-2 " >
                                    ...
                                    <td class="w-48 uppercase text-center" >{{ ( officerRank.location ) }}</td>
                                    <td class="w-48 uppercase text-center" >{{ ( officerRank.certificate ) }}</td>
        ...
        setup(props){
            ...
            function formToggler() {
                ...
                if( formHelper.value == true ){
                    ...
                    officerRank.location = '' 
                    officerRank.certificate = '' 
                    officerRank.date = '' 
            ...
            function save(){
                ...
                selectedRank.value != undefined && selectedRank.value != null && selectedRank.value.id > 0 
                    ...
                    ? {
                        ...
                        location : officerRank.location ,
                        certificate : officerRank.certificate ,
            ...
            function edit(language){
                ...
                officerRank.location = selectedRank.value.location
                officerRank.certificate = selectedRank.value.certificate
