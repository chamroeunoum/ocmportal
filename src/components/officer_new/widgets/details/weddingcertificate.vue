                                    ...
                                    <n-form class="flex flex-wrap w-full " >
                                        <div class="w-1/2 p-4 " >
                                            <div class=" border border-gray-200 bg-white shadow p-4 rounded-lg flex flex-wrap" >
                                                <div class="w-full mb-4 border-b border-gray-200 pb-2 font-moul " >សំបុត្របញ្ជាក់អាពាហ៍ពិពាហ៍</div>
                                        ...
                                        <div class="w-1/2 p-4 " >
                                            <div class=" border border-gray-200 bg-white shadow p-4 rounded-lg flex flex-wrap" >
                                                <div class="w-full mb-4 border-b border-gray-200 pb-2 font-moul" >ទីតាំងផ្ដល់សំបុត្របញ្ជាក់អាពាហ៍ពិពាហ៍</div>
