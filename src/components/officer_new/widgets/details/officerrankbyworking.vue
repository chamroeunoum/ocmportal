                        ...
                        <table class="w-full" >
                            <thead>
                                <tr class="w-full " >
                                    ...
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ចាស់</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ថ្មី</th>
                        ...
                        <n-scrollbar>
                            <div class="form-panel border border-gray-200 rounded-md m-4  bg-white shadow w-2/3 mx-auto " >
                                <div class="w-full p-4 " >
                                    <div class="relative w-full mb-4 border-b border-gray-200 pb-2 font-moul " >ការដំឡើងឋានន្តរស័ក្កិ និងថ្នាក់
                                        <svg 
                                    ...
                                    <n-form class="flex flex-wrap w-full " >
                                        ...
                                        <n-form-item label="ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ចាស់" class="w-1/2 p-1" >
                                            <n-select v-model:value="officerRank.previous_rank_id" placeholder="ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ចាស់" :options="ranks" ></n-select>
                                        </n-form-item>
                                        <n-form-item label="ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ថ្មី" class="w-1/2 p-1" >
                                            <n-select v-model:value="officerRank.rank_id" placeholder="ក្របខណ្ឌឋានន្តរស័ក្កិ និងថ្នាក់ថ្មី" :options="ranks" ></n-select>
                                        </n-form-item>
