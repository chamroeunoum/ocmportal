    ...
    <div v-if="show" class="birth-information absolute left-0 right-0 bottom-0 top-0 bg-white" >
        <Transition name="slide-fade" >
            <div v-if="record != undefined && record != null " class="absolute left-0 right-0 bottom-0 top-0 p-8 mb-0" >
                <div class="font-moul border-b border-gray-200 w-full pb-2 mb-4 h-8 leading-6 relative" >ព័ត៌មានភាសាបរទេស
                ...
                <n-scrollbar >
                    <div class="body" >
                        <table class="w-full" >
                            <thead>
                                <tr class="w-full " >
                                    ...
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ភាសាបរទេស</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ការអាន</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ការសន្ទនា</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ការសសេរ</th>
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black w-20" >ប្រតិបត្តិការ</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(lang , index) in languages" :key="index" class="certificate relative w-full rounded-lg shadow bg-white mb-2 " >
                                    <td class="w-12 index p-1 text-center font-bold" >{{ $toKhmer( index + 1 ) }}</td>
                                    <td class="w-24 p-1 " >{{ $toKhmer( lang.name ) }}</td>
                                    <td class="w-24 certificate_leverl p-1 uppercase text-center" >{{ ( lang.reading ) }}</td>
                                    <td class="w-48 uppercase text-center" >{{ ( lang.speaking ) }}</td>
                                    <td class="w-48 uppercase text-center" >{{ ( lang.writing ) }}</td>
                                    <td class="flex w-20" >
                                        <svg 
                                        @click="uploadToggler(lang)" 
                        ...
                        <div v-if="languages == undefined || languages == null || ( languages.length <= 0 )" >
                        ...
                        <n-scrollbar>
                            <div class="form-panel border border-gray-200 rounded-md m-4  bg-white shadow w-2/3 mx-auto " >
                                <div class="w-full p-4 " >
                                    <div class="relative w-full mb-4 border-b border-gray-200 pb-2 font-moul " >ព័ត៌មានភាសាបរទេស
                                        <svg 
                                    ...
                                    <n-form class="flex flex-wrap w-full " >
                                        <n-form-item label="ភាសាបរទេស" class="w-full p-1" >
                                            <n-input v-model:value="lang.name" placeholder="ភាសាបរទេស" />
                                        </n-form-item>
                                        <n-form-item label="ការអាន" class="w-1/3 p-1" >
                                            <n-radio-group v-model:value="lang.reading" name="reading">
                                                <n-space>
                                                    <n-radio
                                                        value="a"
                                                        label="A (ល្អ)"
                                        ...
                                        <n-form-item label="ការសន្ទនា" class="w-1/3 p-1" >
                                            <n-radio-group v-model:value="lang.speaking" name="speaking">
                                                <n-space>
                                                    <n-radio
                                                        value="a"
                                                        label="A (ល្អ)"
                                        ...
                                        <n-form-item label="ការសសេរ" class="w-1/3 p-1" >
                                            <n-radio-group v-model:value="lang.writing" name="writing">
                                                <n-space>
                                                    <n-radio
                                                        value="a"
                                                        label="A (ល្អ)"
        ...
        setup(props){
            ...
            function formToggler() {
                ...
                if( formHelper.value == true ){
                    ...
                    lang.people_id = props.record.id
                    lang.name = 'ខ្មែរ'
                    lang.reading = 'b'
                    lang.speaking = 'b'
                    lang.writing = 'b'
            ...
            function edit(language){
                ...
                lang.id = selectedLanguage.value.id
                lang.people_id = selectedLanguage.value.people_id
                lang.name = selectedLanguage.value.name
                lang.reading = selectedLanguage.value.reading
                lang.speaking = selectedLanguage.value.speaking
                lang.writing = selectedLanguage.value.writing
