<template>
  <!-- Form edit account -->
    <div class="vcb-pop-create font-ktr">
      <n-modal v-bind:show="show" :on-esc="closePdf" :on-mask-click="closePdf" :on-after-enter="initial" transform-origin="center">
          ...
          <n-tooltip trigger="hover">
            <template #trigger>
              <div class="absolute text-red-500 top-2 right-6 p-2 cursor-pointer bg-opacity-50 hover:bg-opacity-100 duration-300 bg-white shadow-md rounded-full" @click="closePdf" >
                <svg class="w-8 h-8 " @click="onClose" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><path d="M24 9.4L22.6 8L16 14.6L9.4 8L8 9.4l6.6 6.6L8 22.6L9.4 24l6.6-6.6l6.6 6.6l1.4-1.4l-6.6-6.6L24 9.4z" fill="currentColor"></path></svg>
              </div>
