<template>
  <div class="screen-background w-full m-2 rounded-lg overflow-hidden shadow-lg relative">
    ...
    <div class="absolute bottom-0 px-1 left-0 text-xxxxs z-50 mx-auto bg-white text-gray-600 rounded text-left pl-4" >
...
export default {
  ...
  setup(){
    ...
    const bodyHeight = computed(() => {
      return windowHeight.value * 0.84 - 80
    })
    ...
    function chunkRecords( responseRecords ){
      if( errorGetScheduleMeeting.value == false && responseRecords.length > 0 ){
        schedulePages.value = []
...
@import url(./../../layouts/welcome/backup/min-w-300.css);
@import url(./../../layouts/welcome/backup/min-w-400.css);
@import url(./../../layouts/welcome/backup/min-w-500.css);
@import url(./../../layouts/welcome/backup/min-w-600.css);
@import url(./../../layouts/welcome/backup/min-w-700.css);
@import url(./../../layouts/welcome/backup/min-w-800.css);
@import url(./../../layouts/welcome/backup/min-w-900.css);
@import url(./../../layouts/welcome/backup/min-w-1000.css);
@import url(./../../layouts/welcome/backup/min-w-1100.css);
@import url(./../../layouts/welcome/backup/min-w-1200.css);
@import url(./../../layouts/welcome/backup/min-w-1400.css);
@import url(./../../layouts/welcome/backup/min-w-1500.css);
@import url(./../../layouts/welcome/backup/min-w-2000.css);
@import url(./../../layouts/welcome/backup/min-w-2400.css);
@import url(./../../layouts/welcome/backup/min-w-2800.css);
</style>
